...
class StoreTourRequest extends FormRequest
{
    ...
    {
        return [
            'truck_id.required' => __('Камионот е задолжителен'),
            'driver_id.required' => __('Возачот е задолжителен'),
            'start_location.required' => __('Почетната локација е задолжителна'),
            'end_location.required' => __('Крајната локација е задолжителна'),
        ];
    }
}
